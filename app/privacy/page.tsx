      ...
      <div className="container mx-auto px-4 py-24">
        <div className="prose mx-auto max-w-4xl">
          ...
          <p className="mb-8 text-gray-600">
            삼정펄프(주)는 개인정보 보호를 위해 「개인정보 보호법」 「정보통신망
            이용촉진 및 정보보호 등에 관한 법률」 등 관련 법령과 규정을 준수하고
            있습니다. 삼정펄프(주)는 고객님의 개인정보 유출 및 피해방지를 위해
            최선을 다하겠습니다.
          </p>
          ...
          <section className="mb-12">
            ...
            <ul className="list-inside list-disc space-y-1 pl-4 text-gray-600">
              ...
              <li>
                정부 관계부처가 합동으로 발표한 「긴급상황 시 개인정보 처리 및
                보호수칙」에 따라 재난, 감염병, 급박한 생명/신체 위험을 초래하는
                사건/사고, 급박한 재산손실 등의 긴급상황이 발생하는 경우
              </li>
            </ul>
          </section>
